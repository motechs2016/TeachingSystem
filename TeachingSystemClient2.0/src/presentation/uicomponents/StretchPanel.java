		...
		public UserLabel(String str){
			...
			addMouseListener(new MouseListener(){
				...
				public void mouseReleased(MouseEvent arg0) {
					// TODO Auto-generated method stub
					TeacherUI.textField.setText(getText());
					TeacherUI.panel.remove(TeacherUI.ip);
					TeacherUI.ip=null;
					TeacherUI.panel.repaint();
					TeacherUI.down.setIcon(new ImageIcon(ImaginationPanel.class.getResource("/img/down.png")));
				}
